...
class Bert(nn.Module):
    def __init__(self): 
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/home/hpc/LAB-data/disk-4T/syc_data/irra-v1/irra/IRRA-main_v2/data/bert-base-uncased/vocab.txt')
        modelConfig = BertConfig.from_pretrained('/home/hpc/LAB-data/disk-4T/syc_data/irra-v1/irra/IRRA-main_v2/data/bert-base-uncased/config.json')
        self.textExtractor = BertModel.from_pretrained(
            '/home/hpc/LAB-data/disk-4T/syc_data/irra-v1/irra/IRRA-main_v2/data/bert-base-uncased/pytorch_model.bin', config=modelConfig)
