...
class UCM(BaseDataset):
    ...
    def __init__(self, root='', verbose=True):
        ...
        self.anno_path = op.join(self.dataset_dir, 'ucm_qwen2_qwenchat.json')
        ...
        if verbose:
            self.logger.info("=> UCM_captions Images and Captions are loaded")
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            dataset = {
                ...
                "img_paths": img_paths,
                "caption_pids": caption_pids, # 2025 8 18 改
                "captions": captions
            }
            return dataset, pid_container
